...
class TinymceType extends AbstractType
{
    ...
    public function buildView(FormView $view, FormInterface $form, array $options)
    {
        ...
        $attrs = array_merge($attrs, array(
            ...
            $prefixTinymce.'language' => $this->container->get(MainService::class)->getRequest()->getLocale(),
        ...
        if ((isset($options['tinymceBrowser']) && $options['tinymceBrowser']) || ($this->container->hasParameter('nyroDev_utility.browser.defaultEnable') && $this->container->getParameter('nyroDev_utility.browser.defaultEnable'))) {
            ...
            if ($canBrowse) {
                ...
                $attrs[$prefixTinymce.'external_filemanager_path'] = (isset($options['tinymceBrowser']['url']) ? $options['tinymceBrowser']['url'] : $this->container->get(MainService::class)->generateUrl($this->container->getParameter('nyroDev_utility.browser.defaultRoute'))).'/';
                ...
                /*
                $attrs['data-browser_url'] = isset($options['tinymceBrowser']['url']) ? $options['tinymceBrowser']['url'] : $this->container->get(MainService::class)->generateUrl($this->container->getParameter('nyroDev_utility.tinymce.browserRoute'));
