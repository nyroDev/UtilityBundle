...
:host(.nyroDialogIframe) dialog {
    width: 80vw;
    height: 90vh;
    padding: 0;
}
:host(.nyroDialogIframe) dialog main {
    width: 100%;
    height: 100%;
}
:host(.nyroDialogIframe) dialog iframe {
    width: 100%;
    height: 100%;
    border: none;
}
...
class NyroDialog extends HTMLElement {
    constructor() {
        super();
        this.attachShadow({
            mode: "open",
        ...
        this.addEventListener("click", (e) => {
            let closeDialog = e.target.closest(".cancel, .closeDialog, .nyroDialogClose, .closeDialogAfterClick");
...
window.customElements.define("nyro-dialog", NyroDialog);

export default NyroDialog;
