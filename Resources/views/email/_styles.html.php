...
<style>
  ...
  a, .link { color: <?php echo $view['translator']->trans('nyrodev.email.highlightColor'); ?> !important; text-decoration: underline !important; }
...
<style>
  @media (prefers-color-scheme: dark) {
    ...
    a, .link { color: <?php echo $view['translator']->trans('nyrodev.email.highlightColor'); ?> !important; }
  ...
  [data-ogsc] .link, [data-ogsc] p a { color: <?php echo $view['translator']->trans('nyrodev.email.highlightColor'); ?> !important; } 
