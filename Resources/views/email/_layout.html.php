...
<![endif]-->
    ...
    <?php echo $view->render('@NyroDevUtility/email/_styles.html.php'); ?>
  </head>
  ...
  <body id="body" class="darkmode2 body" bgcolor="#EDEEEF" style="background-color:#EDEEEF;">
    <div role="article" aria-roledescription="email" aria-label="<?php echo $view->escape($subject); ?>" xml:lang="<?php echo $locale; ?>" lang="<?php echo $locale; ?>">
      ...
      <table class="darkmode2" cellpadding="0" cellspacing="0" border="0" role="presentation" style="width:100%; background-color: #EDEEEF;">
        <tr>
          <?php $headerColor = $view['translator']->trans('nyrodev.email.headerColor'); ?>
          <td align="center" valign="top" style="color: <?php echo $view['translator']->trans('nyrodev.email.headerText'); ?>; background-color: <?php echo $headerColor; ?>; background: linear-gradient(<?php echo $headerColor; ?>,<?php echo $headerColor; ?>);">
            <table border="0" cellpadding="0" cellspacing="0" role="presentation" class="header">
              <tr>
                <?php echo $view->render('@NyroDevUtility/email/_logoHeader.html.php', [
                    'title' => $subject,
                ]); ?>
              </tr>
            </table>
